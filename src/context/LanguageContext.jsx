...
const translations = {
  vi: {
    ...
    thisYearRevenue: "Doanh thu năm nay",
    avgTransaction: "Giá trị TB / Giao dịch",
    paidTransactions: "Thanh toán thành công",
    pendingTransactions: "Đang chờ thanh toán",
    cancelledTransactions: "Giao dịch đã hủy",
    viewDaily: "Theo ngày",
    viewMonthly: "Theo tháng",
    viewYearly: "Theo năm",
    transactionHistory: "Lịch sử giao dịch dòng tiền",
    searchTransactions: "Tìm theo mã đơn, email...",
  ...
  en: {
    ...
    thisYearRevenue: "This Year's Revenue",
    avgTransaction: "Avg Value / Order",
    paidTransactions: "Paid Transactions",
    pendingTransactions: "Pending Orders",
    cancelledTransactions: "Cancelled Orders",
    viewDaily: "By Day",
    viewMonthly: "By Month",
    viewYearly: "By Year",
    transactionHistory: "Cash Flow Transaction History",
    searchTransactions: "Search by order code, email...",
