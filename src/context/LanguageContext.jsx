...
const translations = {
  vi: {
    ...
    revenueGrowthChart: "Biểu đồ đường tăng trưởng Doanh thu",
    ...
    currentMonthRevenueDesc: "Doanh thu tháng hiện tại",
    todayGenerated: "Phát sinh hôm nay",
    successfulTransactions: "Giao dịch thành công",
    avgPerOrder: "TB / đơn",
    transactionHistoryDesc: "Hiển thị tất cả giao dịch thanh toán khởi tạo trong hệ thống.",
    allStatuses: "Tất cả trạng thái",
    statusPaidOption: "Đã thanh toán (PAID)",
    statusPendingOption: "Đang chờ (PENDING)",
    statusCancelledOption: "Đã hủy (CANCELLED)",
    statusPaidBadge: "Đã thanh toán",
    statusPendingBadge: "Đang chờ",
    statusCancelledBadge: "Đã hủy",
    orderCodeHeader: "Mã đơn hàng",
    customerHeader: "Khách hàng",
    amountHeader: "Số tiền",
    statusHeader: "Trạng thái",
    timeHeader: "Thời gian",
    customerFallback: "Khách hàng",
    noTransactionsFound: "Không tìm thấy giao dịch nào phù hợp với bộ lọc.",
    loadingTransactions: "Đang tải lịch sử giao dịch...",
    loadingChartData: "Đang tải dữ liệu biểu đồ...",
    noRevenueData: "Chưa có thông tin doanh thu trong khoảng thời gian này.",
  ...
  en: {
    ...
    revenueGrowthChart: "Revenue Growth Trend Line Chart",
    ...
    refresh: "Refresh",
    allTime: "All Time",
    currentMonthRevenueDesc: "Current Month Revenue",
    todayGenerated: "Generated Today",
    successfulTransactions: "Successful Transactions",
    avgPerOrder: "Avg / order",
    transactionHistoryDesc: "Displaying all payment transactions initialized in the system.",
    allStatuses: "All Statuses",
    statusPaidOption: "Paid (PAID)",
    statusPendingOption: "Pending (PENDING)",
    statusCancelledOption: "Cancelled (CANCELLED)",
    ...
    noRevenueData: "No revenue data available for this timeframe.",
