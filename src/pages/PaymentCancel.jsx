...
const PaymentCancel = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background text-text-primary relative overflow-hidden font-sans px-4 transition-colors duration-300">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-red-500/10 rounded-full blur-3xl -z-10 animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-[#52B788]/10 rounded-full blur-3xl -z-10" />

      <div className="w-full max-w-md bg-surface border border-border rounded-2xl p-8 shadow-2xl relative overflow-hidden text-center transition-colors duration-300">
        {/* Decorative Top Line */}
        ...
        <span className="text-xs font-bold text-red-600 dark:text-red-400 tracking-wider uppercase bg-red-500/10 px-3 py-1 rounded-full mb-3 inline-block border border-red-500/20">
          Giao dịch đã hủy
        </span>

        <h3 className="text-2xl font-black text-text-primary mb-2">Đã hủy thanh toán</h3>
